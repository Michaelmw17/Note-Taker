...
class Store {
    ...
    addNote(newNote) {
        ...
        return this.getNotes().then(notes => {
            ...
            const newNoteList = [...notes, newNote]; // Creates a new array with the users in the array notes and adds newNote to the end
            ...
            .then(notes => {
                ...
                this.write(notes);
                    fs.writeFileSync(jsonFilePath, JSON.stringify(database), (err) => {
                        if (err) {
                            console.log("Error in the writeFile if/else statement.")
